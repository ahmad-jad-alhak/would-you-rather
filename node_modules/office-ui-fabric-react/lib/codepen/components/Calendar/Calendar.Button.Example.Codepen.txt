...
class CalendarButtonExample extends React.Component<ICalendarButtonExampleProps, ICalendarButtonExampleState> {
...
ReactDOM.render(<CalendarButtonExample/>,document.getElementById("content"));