...
var BreadcrumbBasicExample = /** @class */ (function (_super) {
    ...
    BreadcrumbBasicExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(Label, { className: exampleStyles.exampleLabel, style: { marginTop: '24px' } }, "With maxDisplayedItems set to two and overflowIndex set to 1 (second element)"),
            React.createElement(Breadcrumb, { items: [
