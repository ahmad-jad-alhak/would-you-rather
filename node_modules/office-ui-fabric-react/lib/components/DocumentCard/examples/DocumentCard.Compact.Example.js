...
import { DocumentCard, DocumentCardActivity, DocumentCardPreview, DocumentCardTitle, DocumentCardType } from 'office-ui-fabric-react/lib/DocumentCard';
    ...
    DocumentCardCompactExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(DocumentCard, { type: DocumentCardType.compact, onClickHref: "http://bing.com" },
                ...
                React.createElement("div", { className: "ms-DocumentCard-details" },
                    React.createElement(DocumentCardTitle, { title: "Conversation about anual report from SharePoint conference", shouldTruncate: true }),
                    React.createElement(DocumentCardActivity, { activity: "Sent a few minutes ago", people: [{ name: 'Kat Larrson', profileImageSrc: TestImages.personaFemale }] })))));
    };
