...
import { BaseComponent, classNamesFunction, createRef, elementContains, getDocument, shallowCompare } from '../../Utilities';
...
var Coachmark = /** @class */ (function (_super) {
    ...
    Coachmark.prototype.render = function () {
        ...
        var _b = this.state, beakLeft = _b.beakLeft, beakTop = _b.beakTop, beakRight = _b.beakRight, beakBottom = _b.beakBottom, isCollapsed = _b.isCollapsed, isBeaconAnimating = _b.isBeaconAnimating, isMeasuring = _b.isMeasuring, entityInnerHostRect = _b.entityInnerHostRect, transformOrigin = _b.transformOrigin, alertText = _b.alertText;
                ...
                React.createElement("div", { className: classNames.translateAnimationContainer, ref: this._translateAnimationContainer },
                    React.createElement("div", { className: classNames.scaleAnimationLayer },
                        React.createElement("div", { className: classNames.rotateAnimationLayer },
                            this._positioningContainer.current && (React.createElement(Beak, { left: beakLeft, top: beakTop, right: beakRight, bottom: beakBottom, direction: this._beakDirection, color: color })),
                            React.createElement(FocusTrapZone, { isClickableOutsideFocusTrap: true },
                                React.createElement("div", { className: classNames.entityHost, tabIndex: -1, "data-is-focusable": true, role: "dialog", "aria-labelledby": ariaLabelledBy, "aria-describedby": ariaDescribedBy },
                                    isCollapsed && [
                                    ...
                                    React.createElement("div", { className: classNames.entityInnerHost, ref: this._entityInnerHostElement, "aria-hidden": isCollapsed }, children)))))))));
    };
