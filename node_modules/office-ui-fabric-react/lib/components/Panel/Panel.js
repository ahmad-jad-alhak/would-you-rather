...
import { BaseComponent, css, divProperties, getId, getNativeProps, getRTL, createRef, elementContains, allowScrollOnElement } from '../../Utilities';
        ...
        _this._onRenderHeader = function (props, defaultRender, headerTextId) {
            ...
            if (headerText) {
                return (React.createElement("div", { className: css('ms-Panel-header', styles.header) },
                    React.createElement("p", { className: css('ms-Panel-headerText', styles.headerText, headerClassName), id: headerTextId, role: "heading", "aria-level": 2 }, headerText)));
            }
            return null;
        };
