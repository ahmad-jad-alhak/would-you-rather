...
var DatePickerInputExample = /** @class */ (function (_super) {
    ...
    DatePickerInputExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "docs-DatePickerExample" },
            ...
            React.createElement(DatePicker, { label: "Start date", isRequired: false, allowTextInput: true, ariaLabel: desc, firstDayOfWeek: firstDayOfWeek, strings: DayPickerStrings, value: value, onSelectDate: this._onSelectDate }),
