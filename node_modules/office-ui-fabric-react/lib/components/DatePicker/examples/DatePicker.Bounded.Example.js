...
var DatePickerBoundedExample = /** @class */ (function (_super) {
    ...
    DatePickerBoundedExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "docs-DatePickerExample" },
            ...
            React.createElement(DatePicker, { isRequired: false, firstDayOfWeek: firstDayOfWeek, strings: DayPickerStrings, placeholder: "Select a date...", minDate: minDate, maxDate: maxDate, allowTextInput: true })));
    };
