...
var ScrollablePaneDetailsListExample = /** @class */ (function (_super) {
    ...
    function ScrollablePaneDetailsListExample(props) {
        ...
        _this._scrollablePane = createRef();
        var items = [];
    ...
    ScrollablePaneDetailsListExample.prototype.render = function () {
        ...
        return (React.createElement("div", { style: {
            ...
            React.createElement(ScrollablePane, { componentRef: this._scrollablePane, scrollbarVisibility: "always" /* always */ },
                React.createElement(Sticky, { stickyPosition: StickyPositionType.Header }, selectionDetails),
...
function onRenderDetailsFooter(props, defaultRender) {
    return (React.createElement(Sticky, { stickyPosition: StickyPositionType.Footer, isScrollSynced: true },
        React.createElement(DetailsRow, { columns: props.columns, item: {
                key: 'footer',
                test1: 'Total 1',
                test2: 'Total 2',
                test3: 'Total 3',
                ...
                test5: 'Total 5',
                test6: 'Total 6'
            }, itemIndex: -1, selection: props.selection, selectionMode: (props.selection && props.selection.mode) || SelectionMode.none })));
}
