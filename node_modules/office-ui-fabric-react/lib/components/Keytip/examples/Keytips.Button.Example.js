...
var KeytipsButtonExample = /** @class */ (function (_super) {
    ...
    KeytipsButtonExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(CompoundButton, { keytipProps: keytipMap.CompoundButton, text: "Compound Button", secondaryText: 'With a Keytip', onClick: function () {
            ...
            React.createElement(DefaultButton, { keytipProps: keytipMap.SplitButton, text: "Split Button", split: true, onClick: function () {
            ...
            React.createElement(DefaultButton, { keytipProps: keytipMap.ButtonOffset, text: "Button keytip offset 10x10", onClick: function () {
                    console.log('Button');
                } }),
