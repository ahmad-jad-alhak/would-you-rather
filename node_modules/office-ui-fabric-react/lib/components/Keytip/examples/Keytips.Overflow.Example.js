...
var KeytipsOverflowExample = /** @class */ (function (_super) {
    ...
    KeytipsOverflowExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(OverflowSet, { items: this.state.items, overflowItems: this.state.overflowItems, keytipSequences: keytipMap.OverflowButton4.keySequences, onRenderOverflowButton: this._onRenderOverflowButton, onRenderItem: this._onRenderItem }),
