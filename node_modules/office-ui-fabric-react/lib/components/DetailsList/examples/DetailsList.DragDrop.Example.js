...
var DetailsListDragDropExample = /** @class */ (function (_super) {
    ...
    DetailsListDragDropExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'detailsListDragDropExample' },
            React.createElement(Toggle, { label: 'Enable Column Reorder', checked: isColumnReorderEnabled, onChange: this._onChangeColumnReorderEnabled, onText: 'Enabled', offText: 'Disabled' }),
            React.createElement(TextField, { label: 'Number of Left frozen columns:', onGetErrorMessage: this._validateNumber, value: frozenColumnCountFromStart, onChange: this._onChangeStartCountText }),
            React.createElement(TextField, { label: 'Number of Right frozen columns:', onGetErrorMessage: this._validateNumber, value: frozenColumnCountFromEnd, onChange: this._onChangeEndCountText }),
            React.createElement("div", null, selectionDetails),
            React.createElement(MarqueeSelection, { selection: this._selection },
                React.createElement(DetailsList, { setKey: 'items', items: items, columns: columns, selection: this._selection, selectionPreservedOnEmptyClick: true, onItemInvoked: this._onItemInvoked, onRenderItemColumn: this._onRenderItemColumn, dragDropEvents: this._getDragDropEvents(), columnReorderOptions: this.state.isColumnReorderEnabled ? this._getColumnReorderOptions() : undefined }))));
    };
