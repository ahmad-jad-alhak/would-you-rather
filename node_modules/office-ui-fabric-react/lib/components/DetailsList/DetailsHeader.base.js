...
var DetailsHeaderBase = /** @class */ (function (_super) {
    ...
    DetailsHeaderBase.prototype._renderColumnSizer = function (columnIndex) {
        ...
        var classNames = this._classNames;
        return (React.createElement("div", { key: column.key + "_sizer", "aria-hidden": true, role: "button", "data-is-focusable": false, onClick: stopPropagation, "data-sizer-index": columnIndex, onBlur: this._onSizerBlur, className: css(classNames.cellSizer, columnIndex < columns.length - 1 ? classNames.cellSizerStart : classNames.cellSizerEnd, (_b = {},
