...
var BorderBlindsIcon = function (props) {
    ...
    return (React.createElement(Icon, { iconName: "borderblinds-svg", className: mergeStyles('ms-IconExample', {
            width: 50,
            height: 50,
            selectors: {
                '.borderblinds-part1': {
...
var IconSvgExample = /** @class */ (function (_super) {
    ...
    IconSvgExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Icon, { iconName: "onedrive-svg", className: "ms-IconExample" }),
            React.createElement(Icon, { iconName: "yammer-svg", className: mergeStyles('ms-IconExample', {
                    fill: 'red',
                    selectors: {
                        '.thing': {
                            fill: 'green'
