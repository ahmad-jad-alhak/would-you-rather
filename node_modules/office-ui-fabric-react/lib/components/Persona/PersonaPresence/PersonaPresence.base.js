...
var PersonaPresenceBase = /** @class */ (function (_super) {
    ...
    function PersonaPresenceBase(props) {
        ...
        _this._onRenderIcon = function (className, style) { return (React.createElement(Icon, { className: className, iconName: _this._determineIcon(), style: style })); };
    ...
    PersonaPresenceBase.prototype.render = function () {
        ...
        var renderIcon = !(size.isSize10 || size.isSize16 || size.isSize24 || size.isSize28 || size.isSize32) &&
