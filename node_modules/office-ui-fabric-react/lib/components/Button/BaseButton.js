...
import { BaseComponent, anchorProperties, assign, buttonProperties, getId, getNativeProps, createRef, css, mergeAriaAttributeValues } from '../../Utilities';
...
var BaseButton = /** @class */ (function (_super) {
    ...
    function BaseButton(props, rootClassName) {
        ...
        _this._onSplitContainerFocusCapture = function (ev) {
            ...
            _this._splitButtonContainer.current && _this._splitButtonContainer.current.focus();
        };
    ...
    BaseButton.prototype.render = function () {
        ...
        this._classNames = getClassNames
            ...
            : getBaseButtonClassNames(styles, className, variantClassName, iconProps && iconProps.className, menuIconProps && menuIconProps.className, isPrimaryButtonDisabled, checked, !!menuProps, this.props.split);
