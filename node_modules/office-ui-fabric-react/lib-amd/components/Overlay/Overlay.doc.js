define(["require", "exports", "react", "./examples/Overlay.Dark.Example", "./examples/Overlay.Light.Example", "./Overlay.checklist"], function (require, exports, React, Overlay_Dark_Example_1, Overlay_Light_Example_1, Overlay_checklist_1) {
    "use strict";
    ...
    exports.OverlayPageProps = {
        ...
        componentStatus: Overlay_checklist_1.OverlayStatus,
        examples: [
            {
                title: 'Light',
