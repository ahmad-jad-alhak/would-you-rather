define(["require", "exports", "react", "./Breadcrumb.checklist", "./examples/Breadcrumb.Basic.Example", "./examples/Breadcrumb.Static.Example"], function (require, exports, React, Breadcrumb_checklist_1, Breadcrumb_Basic_Example_1, Breadcrumb_Static_Example_1) {
    "use strict";
    ...
    var BreadcrumbStaticExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/Breadcrumb/Breadcrumb.Static.Example.Codepen.txt');
    exports.BreadcrumbPageProps = {
        ...
        componentStatus: Breadcrumb_checklist_1.BreadcrumbStatus,
        examples: [
            {
