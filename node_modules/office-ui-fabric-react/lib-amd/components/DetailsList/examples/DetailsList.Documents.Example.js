define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/TextField", "office-ui-fabric-react/lib/Toggle", "office-ui-fabric-react/lib/DetailsList", "office-ui-fabric-react/lib/MarqueeSelection", "office-ui-fabric-react/lib/utilities/exampleData", "./DetailsListExample.scss"], function (require, exports, tslib_1, React, TextField_1, Toggle_1, DetailsList_1, MarqueeSelection_1, exampleData_1) {
    "use strict";
    ...
    var DetailsListDocumentsExample = /** @class */ (function (_super) {
        ...
        DetailsListDocumentsExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement(Toggle_1.Toggle, { label: "Enable Modal Selection", checked: this.state.isModalSelection, onChange: this._onChangeModalSelection, onText: "Modal", offText: "Normal" }),
                React.createElement("div", null, selectionDetails),
                React.createElement(TextField_1.TextField, { label: "Filter by name:", onChange: this._onChangeText }),
                React.createElement(MarqueeSelection_1.MarqueeSelection, { selection: this._selection },
                    React.createElement(DetailsList_1.DetailsList, { items: items, compact: isCompactMode, columns: columns, selectionMode: this.state.isModalSelection ? DetailsList_1.SelectionMode.multiple : DetailsList_1.SelectionMode.none, setKey: "set", layoutMode: DetailsList_1.DetailsListLayoutMode.justified, isHeaderVisible: true, selection: this._selection, selectionPreservedOnEmptyClick: true, onItemInvoked: this._onItemInvoked, enterModalSelectionOnTouch: true }))));
        };
