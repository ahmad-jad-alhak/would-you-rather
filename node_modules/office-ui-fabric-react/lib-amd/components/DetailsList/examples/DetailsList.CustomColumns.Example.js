define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/utilities/exampleData", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/Image", "office-ui-fabric-react/lib/DetailsList"], function (require, exports, tslib_1, React, exampleData_1, Link_1, Image_1, DetailsList_1) {
    "use strict";
    ...
    function _renderItemColumn(item, index, column) {
        ...
        switch (column.key) {
            ...
            case 'color':
                return (React.createElement("span", { "data-selection-disabled": true, style: { color: fieldContent, height: '100%', display: 'block' } }, fieldContent));
            default:
