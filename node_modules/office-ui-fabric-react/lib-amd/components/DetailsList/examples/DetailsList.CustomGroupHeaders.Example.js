define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/DetailsList", "office-ui-fabric-react/lib/utilities/exampleData", "./DetailsListExample.scss"], function (require, exports, tslib_1, React, Link_1, DetailsList_1, exampleData_1) {
    "use strict";
    ...
    var DetailsListCustomGroupHeadersExample = /** @class */ (function (_super) {
        ...
        function DetailsListCustomGroupHeadersExample(props) {
            ...
            _items = _items || exampleData_1.createListItems(500);
            _groups = _groups || exampleData_1.createGroups(GROUP_COUNT, 1, 0, ITEMS_PER_GROUP);
            return _this;
        }
                ...
                React.createElement(DetailsList_1.DetailsList, { items: _items, groups: _groups, groupProps: {
                        onRenderHeader: function (props) { return (React.createElement("div", { className: "DetailsListExample-customHeader" },
                            ...
                            React.createElement("div", { className: "DetailsListExample-customHeaderLinkSet" },
                                React.createElement(Link_1.Link, { className: "DetailsListExample-customHeaderLink", onClick: _this._onToggleSelectGroup(props) }, props.isSelected ? 'Remove selection' : 'Select group'),
                                React.createElement(Link_1.Link, { className: "DetailsListExample-customHeaderLink", onClick: _this._onToggleCollapse(props) }, props.group.isCollapsed ? 'Expand group' : 'Collapse group')))); },
