define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/TextField", "office-ui-fabric-react/lib/CommandBar", "office-ui-fabric-react/lib/ContextualMenu", "office-ui-fabric-react/lib/DetailsList", "office-ui-fabric-react/lib/utilities/exampleData", "./DetailsList.Advanced.Example.scss"], function (require, exports, tslib_1, React, Link_1, TextField_1, CommandBar_1, ContextualMenu_1, DetailsList_1, exampleData_1) {
    "use strict";
        ...
        function DetailsListAdvancedExample(props) {
            ...
            _this._onSortColumn = function (key, isSortedDescending) {
                var sortedItems = _items
                    .slice(0)
                    .sort(function (a, b) { return ((isSortedDescending ? a[key] < b[key] : a[key] > b[key]) ? 1 : -1); });
                _this.setState({
                    items: sortedItems,
                    groups: undefined,
