    ...
    var DetailsHeaderBase = /** @class */ (function (_super) {
        ...
        function DetailsHeaderBase(props) {
            ...
            _this._getDropHintPositions = function () {
                ...
                var columnReorderProps = _this._columnReorderProps;
                var prevX = 0;
                var prevMid = 0;
                var prevRef;
        ...
        DetailsHeaderBase.prototype.render = function () {
            ...
            var columnReorderProps = this._columnReorderProps;
            var _c = this.state, isAllSelected = _c.isAllSelected, columnResizeDetails = _c.columnResizeDetails, isSizing = _c.isSizing, groupNestingDepth = _c.groupNestingDepth, isAllCollapsed = _c.isAllCollapsed;
            ...
            return (React.createElement(FocusZone_1.FocusZone, { role: "row", "aria-label": ariaLabel, className: classNames.root, componentRef: this._rootComponent, ref: this._onRootRef, onMouseMove: this._onRootMouseMove, "data-automationid": "DetailsHeader", style: { minWidth: viewport ? viewport.width : 0 }, direction: FocusZone_1.FocusZoneDirection.horizontal },
                showCheckbox
                    ? [
                        React.createElement("div", { key: "__checkbox", className: classNames.cellIsCheck, "aria-labelledby": this._id + "-check", onClick: !isCheckboxHidden ? this._onSelectAllClicked : undefined, "aria-colindex": 1, role: 'columnheader', "aria-hidden": isCheckboxHidden ? true : undefined }, onRenderColumnHeaderTooltip({
                            hostClassName: Utilities_1.css(classNames.checkTooltip),
                            id: this._id + "-checkTooltip",
                            setAriaDescribedBy: false,
                            content: ariaLabelForSelectAllCheckbox,
                            children: (React.createElement(DetailsRowCheck_1.DetailsRowCheck, { id: this._id + "-check", "aria-label": ariaLabelForSelectionColumn, "aria-describedby": this._id + "-checkTooltip", "data-is-focusable": !isCheckboxHidden, isHeader: true, selected: isAllSelected, anySelected: false, canSelect: !isCheckboxHidden, className: classNames.check }))
                    ...
                    : null,
                groupNestingDepth > 0 && this.props.collapseAllVisibility === GroupedList_1.CollapseAllVisibility.visible ? (React.createElement("div", { className: classNames.cellIsGroupExpander, onClick: this._onToggleCollapseAll, "data-is-focusable": true },
                    React.createElement(Icon_1.Icon, { className: classNames.collapseButton, iconName: "ChevronDown" }))) : null,
                ...
                columns.map(function (column, columnIndex) {
                    ...
                    return [
                        ...
                        React.createElement(DetailsColumn_1.DetailsColumn, { column: column, key: column.key, columnIndex: (showCheckbox ? 2 : 1) + columnIndex, parentId: _this._id, isDraggable: _isDraggable, updateDragInfo: _this._updateDragInfo, dragDropHelper: _this._dragDropHelper, onColumnClick: onColumnClick, onColumnContextMenu: onColumnContextMenu, isDropped: _this._onDropIndexInfo.targetIndex === columnIndex, cellStyleProps: _this.props.cellStyleProps }),
