define(["require", "exports", "react", "./examples/Image.Default.Example", "./examples/Image.Center.Example", "./examples/Image.Contain.Example", "./examples/Image.Cover.Example", "./examples/Image.None.Example", "./examples/Image.MaximizeFrame.Example", "./Image.checklist", "./ImagePage.global.scss"], function (require, exports, React, Image_Default_Example_1, Image_Center_Example_1, Image_Contain_Example_1, Image_Cover_Example_1, Image_None_Example_1, Image_MaximizeFrame_Example_1, Image_checklist_1) {
    "use strict";
    ...
    exports.ImagePageProps = {
        ...
        componentStatus: Image_checklist_1.ImageStatus,
        examples: [
            {
