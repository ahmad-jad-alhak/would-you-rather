define(["require", "exports", "../../utilities/color/shades", "../../utilities/color/colors", "../../Utilities"], function (require, exports, shades_1, colors_1, Utilities_1) {
    "use strict";
    ...
    function themeRulesStandardCreator() {
        ...
        slotRules[BaseSlots[BaseSlots.primaryColor]].color = colors_1.getColorFromString('#0078d4');
        slotRules[BaseSlots[BaseSlots.backgroundColor]].color = colors_1.getColorFromString('#fff');
        slotRules[BaseSlots[BaseSlots.foregroundColor]].color = colors_1.getColorFromString('#333');
        // set default colors for shades (the slot rules were already created above and will be used if the base colors ever change)
        slotRules[BaseSlots[BaseSlots.primaryColor] + shades_1.Shade[shades_1.Shade.Shade1]].color = colors_1.getColorFromString('#eff6fc');
        slotRules[BaseSlots[BaseSlots.primaryColor] + shades_1.Shade[shades_1.Shade.Shade2]].color = colors_1.getColorFromString('#deecf9');
        slotRules[BaseSlots[BaseSlots.primaryColor] + shades_1.Shade[shades_1.Shade.Shade3]].color = colors_1.getColorFromString('#c7e0f4');
        slotRules[BaseSlots[BaseSlots.primaryColor] + shades_1.Shade[shades_1.Shade.Shade4]].color = colors_1.getColorFromString('#71afe5');
        slotRules[BaseSlots[BaseSlots.primaryColor] + shades_1.Shade[shades_1.Shade.Shade5]].color = colors_1.getColorFromString('#2b88d8');
        slotRules[BaseSlots[BaseSlots.primaryColor] + shades_1.Shade[shades_1.Shade.Shade6]].color = colors_1.getColorFromString('#106ebe');
        slotRules[BaseSlots[BaseSlots.primaryColor] + shades_1.Shade[shades_1.Shade.Shade7]].color = colors_1.getColorFromString('#005a9e');
        slotRules[BaseSlots[BaseSlots.primaryColor] + shades_1.Shade[shades_1.Shade.Shade8]].color = colors_1.getColorFromString('#004578');
        // set default colors for shades (the slot rules were already created above and will be used if the base colors ever change)
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade1]].color = colors_1.getColorFromString('#eaeaea');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade2]].color = colors_1.getColorFromString('#c8c8c8');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade3]].color = colors_1.getColorFromString('#a6a6a6');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade4]].color = colors_1.getColorFromString('#767676');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade5]].color = colors_1.getColorFromString('#666666');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade6]].color = colors_1.getColorFromString('#3c3c3c');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade7]].color = colors_1.getColorFromString('#212121');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade8]].color = colors_1.getColorFromString('#000000');
        ...
        slotRules[FabricSlots[FabricSlots.themeLighterAlt]].color = colors_1.getColorFromString('#eff6fc');
        slotRules[FabricSlots[FabricSlots.themeLighter]].color = colors_1.getColorFromString('#deecf9');
        slotRules[FabricSlots[FabricSlots.themeLight]].color = colors_1.getColorFromString('#c7e0f4');
        slotRules[FabricSlots[FabricSlots.themeTertiary]].color = colors_1.getColorFromString('#71afe5');
        slotRules[FabricSlots[FabricSlots.themeSecondary]].color = colors_1.getColorFromString('#2b88d8');
        slotRules[FabricSlots[FabricSlots.themeDarkAlt]].color = colors_1.getColorFromString('#106ebe');
        slotRules[FabricSlots[FabricSlots.themeDark]].color = colors_1.getColorFromString('#005a9e');
        slotRules[FabricSlots[FabricSlots.themeDarker]].color = colors_1.getColorFromString('#004578');
