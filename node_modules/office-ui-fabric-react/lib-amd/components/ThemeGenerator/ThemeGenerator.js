define(["require", "exports", "../../utilities/color/colors", "../../utilities/color/shades", "../../Utilities"], function (require, exports, colors_1, shades_1, Utilities_1) {
    "use strict";
        ...
        ThemeGenerator.setSlot = function (rule, color, isInverted, isCustomization, overwriteCustomColor) {
            ...
            if (overwriteCustomColor) {
                ...
                if (typeof color === 'string') {
                    colorAsIColor = colors_1.getColorFromString(color); // the ! is a lie here but we'll verify it in the next line
                    if (!colorAsIColor) {
