define(["require", "exports", "react", "./examples/Facepile.AddFace.Example", "./examples/Facepile.Basic.Example", "./examples/Facepile.Overflow.Example", "./Facepile.checklist"], function (require, exports, React, Facepile_AddFace_Example_1, Facepile_Basic_Example_1, Facepile_Overflow_Example_1, Facepile_checklist_1) {
    "use strict";
    ...
    exports.FacepilePageProps = {
        ...
        componentStatus: Facepile_checklist_1.FacepileStatus,
        examples: [
            {
