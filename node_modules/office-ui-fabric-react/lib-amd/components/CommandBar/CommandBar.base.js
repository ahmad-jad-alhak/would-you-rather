define(["require", "exports", "tslib", "react", "../../Utilities", "../../OverflowSet", "../../ResizeGroup", "../../FocusZone", "../../Utilities", "../../Button", "../../Tooltip"], function (require, exports, tslib_1, React, Utilities_1, OverflowSet_1, ResizeGroup_1, FocusZone_1, Utilities_2, Button_1, Tooltip_1) {
    ...
    var CommandBarBase = /** @class */ (function (_super) {
        ...
        function CommandBarBase() {
            ...
            _this._overflowSet = Utilities_2.createRef();
            _this._resizeGroup = Utilities_2.createRef();
            ...
            _this._onRenderItem = function (item) {
                var _a = _this.props.buttonAs, CommandButtonType = _a === void 0 ? Button_1.CommandBarButton : _a;
                ...
                var commandButtonProps = tslib_1.__assign({ allowDisabledFocus: true }, item, { styles: tslib_1.__assign({ root: { height: '100%' } }, item.buttonStyles), className: Utilities_1.css('ms-CommandBarItem-link', item.className), text: !item.iconOnly ? itemText : undefined, menuProps: item.subMenuProps, onClick: _this._onButtonClick(item) });
            ...
            _this._onRenderOverflowButton = function (overflowItems) {
                ...
                return (React.createElement(OverflowButtonType, tslib_1.__assign({ "aria-posinset": _this._setSize, "aria-setsize": _this._setSize }, overflowProps)));
            };
            _this._onReduceData = function (data) {
                ...
                if (movedItem !== undefined) {
                    ...
                    var newData = _this._setAriaPosinset(tslib_1.__assign({}, data, { primaryItems: primaryItems, overflowItems: overflowItems }));
                    cacheKey = _this._computeCacheKey(newData);
                    if (onDataReduced) {
                        onDataReduced(movedItem);
                    }
                    return tslib_1.__assign({}, newData, { cacheKey: cacheKey });
                }
                return undefined;
            };
        ...
        CommandBarBase.prototype._setAriaPosinset = function (data) {
            var _this = this;
            this._setSize = data.primaryItems.length + (data.overflowItems.length > 0 ? 1 : 0);
            data.primaryItems = data.primaryItems.map(function (item, i, array) {
                item['aria-posinset'] = i + 1;
                item['aria-setsize'] = _this._setSize;
                return item;
            });
            if (data.farItems) {
                data.farItems = data.farItems.map(function (item, i, array) {
                    item['aria-posinset'] = i + 1;
