define(["require", "exports", "react", "./examples/Persona.Initials.Example", "./examples/Persona.Basic.Example", "./examples/Persona.Alternate.Example", "./examples/Persona.CustomRender.Example", "./examples/Persona.CustomCoinRender.Example", "./examples/Persona.UnknownPersona.Example", "./Persona.checklist"], function (require, exports, React, Persona_Initials_Example_1, Persona_Basic_Example_1, Persona_Alternate_Example_1, Persona_CustomRender_Example_1, Persona_CustomCoinRender_Example_1, Persona_UnknownPersona_Example_1, Persona_checklist_1) {
    "use strict";
    ...
    exports.PersonaPageProps = {
        ...
        componentStatus: Persona_checklist_1.PersonaStatus,
        examples: [
            {
