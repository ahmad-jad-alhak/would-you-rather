define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Icon", "office-ui-fabric-react/lib/Styling", "./IconExample.scss"], function (require, exports, tslib_1, React, Icon_1, Styling_1) {
    "use strict";
    ...
    var BorderBlindsIcon = function (props) {
        var _a = props.col1, col1 = _a === void 0 ? 'red' : _a, _b = props.col2, col2 = _b === void 0 ? 'green' : _b, _c = props.col3, col3 = _c === void 0 ? 'blue' : _c;
        return (React.createElement(Icon_1.Icon, { iconName: "borderblinds-svg", className: Styling_1.mergeStyles('ms-IconExample', {
                width: 50,
                height: 50,
                selectors: {
                    '.borderblinds-part1': {
    ...
    var IconSvgExample = /** @class */ (function (_super) {
        tslib_1.__extends(IconSvgExample, _super);
        function IconSvgExample() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        IconSvgExample.prototype.render = function () {
            return (React.createElement("div", null,
                React.createElement(Icon_1.Icon, { iconName: "onedrive-svg", className: "ms-IconExample" }),
                React.createElement(Icon_1.Icon, { iconName: "yammer-svg", className: Styling_1.mergeStyles('ms-IconExample', {
                        fill: 'red',
                        selectors: {
                            '.thing': {
                                fill: 'green'
                ...
                React.createElement(BorderBlindsIcon, { col3: "pink" })));
        };
