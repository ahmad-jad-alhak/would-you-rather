define(["require", "exports", "react", "./examples/ContextualMenu.Basic.Example", "./examples/ContextualMenu.Icon.Example", "./examples/ContextualMenu.Icon.SecondaryText.Example", "./examples/ContextualMenu.Section.Example", "./examples/ContextualMenu.Submenu.Example", "./examples/ContextualMenu.CustomizationWithNoWrap.Example", "./examples/ContextualMenu.Checkmarks.Example", "./examples/ContextualMenu.Directional.Example", "./examples/ContextualMenu.Customization.Example", "./examples/ContextualMenu.ScrollBar.Example", "./examples/ContextualMenu.CustomMenuItem.Example", "./ContextualMenu.checklist"], function (require, exports, React, ContextualMenu_Basic_Example_1, ContextualMenu_Icon_Example_1, ContextualMenu_Icon_SecondaryText_Example_1, ContextualMenu_Section_Example_1, ContextualMenu_Submenu_Example_1, ContextualMenu_CustomizationWithNoWrap_Example_1, ContextualMenu_Checkmarks_Example_1, ContextualMenu_Directional_Example_1, ContextualMenu_Customization_Example_1, ContextualMenu_ScrollBar_Example_1, ContextualMenu_CustomMenuItem_Example_1, ContextualMenu_checklist_1) {
    "use strict";
    ...
    var ContextualMenuBasicExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/ContextualMenu/ContextualMenu.Basic.Example.Codepen.txt');
    ...
    exports.ContextualMenuPageProps = {
        ...
        componentStatus: ContextualMenu_checklist_1.ContextualMenuStatus,
        examples: [
            {
