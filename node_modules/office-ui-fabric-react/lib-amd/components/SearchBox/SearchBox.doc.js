define(["require", "exports", "react", "./examples/SearchBox.FullSize.Example", "./examples/SearchBox.Underlined.Example", "./examples/SearchBox.Disabled.Example", "./examples/SearchBox.Small.Example", "./SearchBox.checklist"], function (require, exports, React, SearchBox_FullSize_Example_1, SearchBox_Underlined_Example_1, SearchBox_Disabled_Example_1, SearchBox_Small_Example_1, SearchBox_checklist_1) {
    "use strict";
    ...
    exports.SearchBoxPageProps = {
        ...
        componentStatus: SearchBox_checklist_1.SearchBoxStatus,
        examples: [
            {
