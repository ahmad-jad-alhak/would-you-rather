define(["require", "exports", "react", "./examples/SpinButton.Basic.Example", "./examples/SpinButton.BasicDisabled.Example", "./examples/SpinButton.Stateful.Example", "./examples/SpinButton.BasicWithIcon.Example", "./examples/SpinButton.BasicWithIconDisabled.Example", "./examples/SpinButton.BasicWithEndPosition.Example", "./examples/SpinButton.CustomStyled.Example", "./SpinButton.checklist"], function (require, exports, React, SpinButton_Basic_Example_1, SpinButton_BasicDisabled_Example_1, SpinButton_Stateful_Example_1, SpinButton_BasicWithIcon_Example_1, SpinButton_BasicWithIconDisabled_Example_1, SpinButton_BasicWithEndPosition_Example_1, SpinButton_CustomStyled_Example_1, SpinButton_checklist_1) {
    "use strict";
    ...
    var SpinButtonBasicExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/SpinButton/SpinButton.Basic.Example.Codepen.txt');
    ...
    exports.SpinButtonPageProps = {
        ...
        componentStatus: SpinButton_checklist_1.SpinButtonStatus,
        examples: [
            {
