define(["require", "exports", "react", "./examples/Panel.SmallRight.Example", "./examples/Panel.SmallLeft.Example", "./examples/Panel.SmallFluid.Example", "./examples/Panel.Medium.Example", "./examples/Panel.Large.Example", "./examples/Panel.LargeFixed.Example", "./examples/Panel.ExtraLarge.Example", "./examples/Panel.Custom.Example", "./examples/Panel.HiddenOnDismiss.Example", "./examples/Panel.LightDismiss.Example", "./examples/Panel.LightDismissCustom.Example", "./examples/Panel.NonModal.Example", "./examples/Panel.Footer.Example", "./Panel.checklist"], function (require, exports, React, Panel_SmallRight_Example_1, Panel_SmallLeft_Example_1, Panel_SmallFluid_Example_1, Panel_Medium_Example_1, Panel_Large_Example_1, Panel_LargeFixed_Example_1, Panel_ExtraLarge_Example_1, Panel_Custom_Example_1, Panel_HiddenOnDismiss_Example_1, Panel_LightDismiss_Example_1, Panel_LightDismissCustom_Example_1, Panel_NonModal_Example_1, Panel_Footer_Example_1, Panel_checklist_1) {
    "use strict";
    ...
    var PanelSmallRightExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/Panel/Panel.SmallRight.Example.Codepen.txt');
    ...
    exports.PanelPageProps = {
        ...
        componentStatus: Panel_checklist_1.PanelStatus,
        examples: [
            {
