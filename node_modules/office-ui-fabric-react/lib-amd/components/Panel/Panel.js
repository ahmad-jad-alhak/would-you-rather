define(["require", "exports", "tslib", "react", "../../Utilities", "../FocusTrapZone/index", "./Panel.types", "../../Layer", "../../Overlay", "../../Popup", "../../Button", "../../Styling", "./Panel.scss"], function (require, exports, tslib_1, React, Utilities_1, index_1, Panel_types_1, Layer_1, Overlay_1, Popup_1, Button_1, Styling_1, stylesImport) {
    "use strict";
            ...
            _this._onRenderHeader = function (props, defaultRender, headerTextId) {
                ...
                if (headerText) {
                    return (React.createElement("div", { className: Utilities_1.css('ms-Panel-header', styles.header) },
                        React.createElement("p", { className: Utilities_1.css('ms-Panel-headerText', styles.headerText, headerClassName), id: headerTextId, role: "heading", "aria-level": 2 }, headerText)));
                }
                return null;
            };
