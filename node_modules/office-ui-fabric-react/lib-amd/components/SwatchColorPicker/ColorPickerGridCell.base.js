define(["require", "exports", "tslib", "react", "../../utilities/color/colors", "../../utilities/grid/GridCell", "../Button/ActionButton/ActionButton.styles", "../../Styling", "../../Utilities"], function (require, exports, tslib_1, React, colors_1, GridCell_1, ActionButton_styles_1, Styling_1, Utilities_1) {
    "use strict";
    ...
    var ColorPickerGridCellBase = /** @class */ (function (_super) {
        ...
        function ColorPickerGridCellBase() {
            ...
            _this._onRenderColorOption = function (colorOption) {
                ...
                return (React.createElement("svg", { className: _this._classNames.svg, viewBox: "0 0 20 20", fill: colors_1.getColorFromString(colorOption.color).str }, _this.props.circle ? React.createElement("circle", { cx: "50%", cy: "50%", r: "50%" }) : React.createElement("rect", { width: "100%", height: "100%" })));
            };
            /**
            ...
            _this._getClassNames = function (theme, className, variantClassName, iconClassName, menuIconClassName, disabled, checked, expanded, isSplit) {
                ...
                return Styling_1.mergeStyleSets(_this._classNames, {
                    root: [
                        'ms-Button',
                        styles.root,
                        variantClassName,
