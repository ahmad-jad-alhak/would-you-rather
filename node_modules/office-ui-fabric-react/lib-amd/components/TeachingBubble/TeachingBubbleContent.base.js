define(["require", "exports", "tslib", "react", "../../Utilities", "../../Button", "../../Image"], function (require, exports, tslib_1, React, Utilities_1, Button_1, Image_1) {
    "use strict";
        ...
        TeachingBubbleContentBase.prototype.render = function () {
            ...
            if (headline) {
                headerContent = (React.createElement("div", { className: classNames.header },
                    React.createElement("p", { className: classNames.headline, id: ariaLabelledBy }, headline)));
            }
            if (children) {
                bodyContent = (React.createElement("div", { className: classNames.body },
                    React.createElement("p", { className: classNames.subText, id: ariaDescribedBy }, children)));
            }
