define(["require", "exports", "react", "./examples/FocusTrapZone.Box.Example", "./examples/FocusTrapZone.Box.FocusOnCustomElement.Example", "./examples/FocusTrapZone.Box.Click.Example", "./examples/FocusTrapZone.Nested.Example", "./examples/FocusTrapZone.DialogInPanel.Example"], function (require, exports, React, FocusTrapZone_Box_Example_1, FocusTrapZone_Box_FocusOnCustomElement_Example_1, FocusTrapZone_Box_Click_Example_1, FocusTrapZone_Nested_Example_1, FocusTrapZone_DialogInPanel_Example_1) {
    "use strict";
        ...
        examples: [
            {
                ...
                view: React.createElement(FocusTrapZone_Box_Example_1.default, null)
            },
            {
                title: 'Simple Box with focus on custom focusable element',
                code: FocusTrapZoneBoxExampleWithFocusableItemCode,
                view: React.createElement(FocusTrapZone_Box_FocusOnCustomElement_Example_1.default, null)
            },
            {
                title: 'Simple Box with Clicking outside Trap Zone enabled',
                code: FocusTrapZoneBoxClickExampleCode,
                view: React.createElement(FocusTrapZone_Box_Click_Example_1.default, null)
            },
            {
                title: 'Multiple Nest FocusTrapZones',
                code: FocusTrapZoneNestedExampleCode,
                view: React.createElement(FocusTrapZone_Nested_Example_1.default, null)
            },
            {
                title: 'A Dialog Nested in a Panel',
                code: FocusTrapZoneDialogInPanelExampleCode,
                view: React.createElement(FocusTrapZone_DialogInPanel_Example_1.default, null)
            }
        ],
