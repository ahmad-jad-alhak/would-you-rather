define(["require", "exports", "react", "./Keytip.checklist", "./examples/Keytips.Basic.Example", "./examples/Keytips.Button.Example", "./examples/Keytips.CommandBar.Example", "./examples/Keytips.Overflow.Example"], function (require, exports, React, Keytip_checklist_1, Keytips_Basic_Example_1, Keytips_Button_Example_1, Keytips_CommandBar_Example_1, Keytips_Overflow_Example_1) {
    "use strict";
    ...
    exports.KeytipsPageProps = {
        ...
        componentStatus: Keytip_checklist_1.KeytipStatus,
        examples: [
            {
