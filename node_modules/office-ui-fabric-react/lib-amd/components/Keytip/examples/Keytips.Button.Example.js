    ...
    var KeytipsButtonExample = /** @class */ (function (_super) {
        ...
        KeytipsButtonExample.prototype.render = function () {
            return (React.createElement("div", null,
                ...
                React.createElement(Button_1.CompoundButton, { keytipProps: KeytipSetup_1.keytipMap.CompoundButton, text: "Compound Button", secondaryText: 'With a Keytip', onClick: function () {
                ...
                React.createElement(Button_1.DefaultButton, { keytipProps: KeytipSetup_1.keytipMap.SplitButton, text: "Split Button", split: true, onClick: function () {
                ...
                React.createElement(Button_1.DefaultButton, { keytipProps: KeytipSetup_1.keytipMap.ButtonOffset, text: "Button keytip offset 10x10", onClick: function () {
                        console.log('Button');
                    } }),
