define(["require", "exports", "react", "./examples/Picker.CustomResult.Example", "./examples/TagPicker.Basic.Example", "./Pickers.checklist"], function (require, exports, React, Picker_CustomResult_Example_1, TagPicker_Basic_Example_1, Pickers_checklist_1) {
    "use strict";
    ...
    exports.PickersPageProps = {
        ...
        componentStatus: Pickers_checklist_1.PickersStatus,
        examples: [
            {
                title: 'Tag Picker',
