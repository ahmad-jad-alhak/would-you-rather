define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/DatePicker", "./DatePicker.Examples.scss"], function (require, exports, tslib_1, React, DatePicker_1) {
    "use strict";
    ...
    var DatePickerRequiredExample = /** @class */ (function (_super) {
        ...
        DatePickerRequiredExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: "docs-DatePickerExample" },
                ...
                React.createElement(DatePicker_1.DatePicker, { label: "Date required (with label)", isRequired: true, firstDayOfWeek: firstDayOfWeek, strings: DayPickerStrings, placeholder: "Select a date..." }),
                React.createElement(DatePicker_1.DatePicker, { isRequired: true, firstDayOfWeek: firstDayOfWeek, strings: DayPickerStrings, placeholder: "Date required with no label..." })));
        };
