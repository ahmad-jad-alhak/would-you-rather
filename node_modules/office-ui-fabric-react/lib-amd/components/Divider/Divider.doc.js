define(["require", "exports", "react", "./examples/VerticalDivider.Basic.Example", "./examples/VerticalDivider.Custom.Example", "./Divider.checklist"], function (require, exports, React, VerticalDivider_Basic_Example_1, VerticalDivider_Custom_Example_1, Divider_checklist_1) {
    "use strict";
    ...
    exports.DividerPageProps = {
        ...
        componentStatus: Divider_checklist_1.DividerStatus,
        examples: [
            {
