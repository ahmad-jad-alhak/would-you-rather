define(["require", "exports", "react", "./examples/TextField.Basic.Example", "./examples/TextField.Borderless.Example", "./examples/TextField.CustomRender.Example", "./examples/TextField.ErrorMessage.Example", "./examples/TextField.Icon.Example", "./examples/TextField.Multiline.Example", "./examples/TextField.Placeholder.Example", "./examples/TextField.Prefix.Example", "./examples/TextField.PrefixAndSuffix.Example", "./TextField.checklist", "./examples/TextField.Styled.Example", "./examples/TextField.Suffix.Example", "./examples/TextField.Underlined.Example", "./examples/TextField.AutoComplete.Example", "./examples/TextField.OnRenderDescription.Example"], function (require, exports, React, TextField_Basic_Example_1, TextField_Borderless_Example_1, TextField_CustomRender_Example_1, TextField_ErrorMessage_Example_1, TextField_Icon_Example_1, TextField_Multiline_Example_1, TextField_Placeholder_Example_1, TextField_Prefix_Example_1, TextField_PrefixAndSuffix_Example_1, TextField_checklist_1, TextField_Styled_Example_1, TextField_Suffix_Example_1, TextField_Underlined_Example_1, TextField_AutoComplete_Example_1, TextField_OnRenderDescription_Example_1) {
    "use strict";
    ...
    var TextFieldBasicExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/TextField/TextField.Basic.Example.Codepen.txt');
    ...
    var TextFieldBorderlessExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/TextField/TextField.Borderless.Example.Codepen.txt');
    ...
    var TextFieldPlaceholderExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/TextField/TextField.Placeholder.Example.Codepen.txt');
    ...
    var TextFieldUnderlinedExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/TextField/TextField.Underlined.Example.Codepen.txt');
    ...
    exports.TextFieldPageProps = {
        ...
        componentStatus: TextField_checklist_1.TextFieldStatus,
        examples: [
            {
            ...
            },
            {
                ...
                view: React.createElement(TextField_Placeholder_Example_1.TextFieldPlaceholderExample, null),
            ...
            },
            {
                ...
                view: React.createElement(TextField_Underlined_Example_1.TextFieldUnderlinedExample, null),
            ...
            },
            {
                ...
                view: React.createElement(TextField_AutoComplete_Example_1.TextFieldAutoCompleteExample, null)
            }
        ],
        implementationExamples: [
            {
                ...
                view: React.createElement(TextField_Prefix_Example_1.TextFieldPrefixExample, null)
            },
            {
                title: 'Textfield with a suffix',
                code: TextFieldSuffixExampleCode,
                view: React.createElement(TextField_Suffix_Example_1.TextFieldSuffixExample, null)
            },
            {
            ...
            },
            {
                ...
                view: React.createElement(TextField_Icon_Example_1.TextFieldIconExample, null)
            },
            {
            ...
            },
            {
                ...
                view: React.createElement(TextField_OnRenderDescription_Example_1.TextFieldOnRenderDescriptionExample, null)
            },
            {
