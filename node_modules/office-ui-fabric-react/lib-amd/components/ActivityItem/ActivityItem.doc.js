define(["require", "exports", "react", "./ActivityItem.checklist", "./examples/ActivityItem.Basic.Example", "./examples/ActivityItem.Persona.Example", "./examples/ActivityItem.Compact.Example"], function (require, exports, React, ActivityItem_checklist_1, ActivityItem_Basic_Example_1, ActivityItem_Persona_Example_1, ActivityItem_Compact_Example_1) {
    "use strict";
    ...
    exports.ActivityItemPageProps = {
        ...
        componentStatus: ActivityItem_checklist_1.ActivityItemStatus,
        examples: [
            {
        ...
        propertiesTablesSources: [
            require('!raw-loader!office-ui-fabric-react/src/components/ActivityItem/ActivityItem.types.ts')
        ],
