define(["require", "exports", "tslib", "react", "../../Utilities", "./Tooltip.types", "../../Callout"], function (require, exports, tslib_1, React, Utilities_1, Tooltip_types_1, Callout_1) {
    "use strict";
    ...
    var TooltipBase = /** @class */ (function (_super) {
        ...
        TooltipBase.prototype.render = function () {
            ...
            return (React.createElement(Callout_1.Callout, tslib_1.__assign({ target: targetElement, directionalHint: directionalHint, directionalHintForRTL: directionalHintForRTL }, calloutProps, Utilities_1.getNativeProps(this.props, Utilities_1.divProperties), { className: this._classNames.root }),
