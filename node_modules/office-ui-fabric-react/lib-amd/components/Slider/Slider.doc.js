define(["require", "exports", "react", "./examples/Slider.Basic.Example", "./Slider.checklist"], function (require, exports, React, Slider_Basic_Example_1, Slider_checklist_1) {
    "use strict";
    ...
    exports.SliderPageProps = {
        ...
        componentStatus: Slider_checklist_1.SliderStatus,
        examples: [
            {
                title: 'Slider',
        ...
        propertiesTablesSources: [
            require('!raw-loader!office-ui-fabric-react/src/components/Slider/Slider.types.ts')
        ],
