define(["require", "exports", "tslib", "react", "../../../Utilities", "./SuggestionsCore", "./SuggestionsControl.scss"], function (require, exports, tslib_1, React, Utilities_1, SuggestionsCore_1, stylesImport) {
    "use strict";
    ...
    var SuggestionsHeaderFooterItem = /** @class */ (function (_super) {
        ...
        SuggestionsHeaderFooterItem.prototype.render = function () {
            ...
            return onExecute ? (React.createElement("div", { id: id, onClick: onExecute, className: Utilities_1.css('ms-Suggestions-sectionButton', styles.actionButton, (_b = {},
                    _b['is-selected ' + styles.buttonSelected] = isSelected,
                    _b)) }, renderItem())) : (React.createElement("div", { id: id, className: Utilities_1.css('ms-Suggestions-section', styles.suggestionsTitle) }, renderItem()));
            var _b;
        };
    ...
    var SuggestionsControl = /** @class */ (function (_super) {
        ...
        SuggestionsControl.prototype.render = function () {
            ...
            return (React.createElement("div", { className: Utilities_1.css('ms-Suggestions', className ? className : '', styles.root) },
                React.createElement("div", { className: styles.screenReaderOnly, role: "alert", id: "selected-suggestion-alert", "aria-live": "assertive" }, this._getAriaLabel()),
        ...
        SuggestionsControl.prototype._getAriaLabel = function () {
            var _a = this.state, selectedHeaderIndex = _a.selectedHeaderIndex, selectedFooterIndex = _a.selectedFooterIndex;
