define(["require", "exports", "tslib", "react", "react-dom", "office-ui-fabric-react/lib/Utilities", "./Button.Basic.Example.styles", "office-ui-fabric-react/lib/Button"], function (require, exports, tslib_1, React, ReactDOM, Utilities_1, Button_Basic_Example_styles_1, Button_1) {
    "use strict";
    ...
    var ButtonSwapExample = /** @class */ (function (_super) {
        ...
        ButtonSwapExample.prototype.render = function () {
            ...
            var button = isPrimary ? (React.createElement(Button_1.PrimaryButton, { ref: this._setButtonRef, disabled: disabled, checked: checked, onClick: this._onClick }, text)) : (React.createElement(Button_1.DefaultButton, { ref: this._setButtonRef, disabled: disabled, checked: checked, onClick: this._onClick }, text));
