define(["require", "exports", "react", "./Button.checklist", "./examples/Button.Default.Example", "./examples/Button.ContextualMenu.Example", "./examples/Button.Compound.Example", "./examples/Button.Action.Example", "./examples/Button.CommandBar.Example", "./examples/Button.Icon.Example", "./examples/Button.Anchor.Example", "./examples/Button.ScreenReader.Example", "./examples/Button.Swap.Example", "./examples/Button.Split.Example", "./examples/Button.Toggle.Example", "../../common/DocPage.types"], function (require, exports, React, Button_checklist_1, Button_Default_Example_1, Button_ContextualMenu_Example_1, Button_Compound_Example_1, Button_Action_Example_1, Button_CommandBar_Example_1, Button_Icon_Example_1, Button_Anchor_Example_1, Button_ScreenReader_Example_1, Button_Swap_Example_1, Button_Split_Example_1, Button_Toggle_Example_1, DocPage_types_1) {
    "use strict";
    ...
    exports.ButtonPageProps = function (props) { return ({
        ...
        implementationExamples: [
            ...
            },
            {
                ...
                view: React.createElement(Button_Swap_Example_1.ButtonSwapExample, { disabled: props.areButtonsDisabled, checked: props.areButtonsChecked })
            },
            {
