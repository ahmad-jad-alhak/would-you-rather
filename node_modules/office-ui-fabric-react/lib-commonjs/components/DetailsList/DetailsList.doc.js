...
var DetailsList_Shimmer_Example_1 = require("./examples/DetailsList.Shimmer.Example");
...
exports.DetailsListPageProps = {
    ...
    componentStatus: DetailsList_checklist_1.DetailsListStatus,
    examples: [
        {
...
exports.DetailsListShimmerPageProps = generateProps({
    ...
    view: React.createElement(DetailsList_Shimmer_Example_1.DetailsListShimmerExample, null)
});
