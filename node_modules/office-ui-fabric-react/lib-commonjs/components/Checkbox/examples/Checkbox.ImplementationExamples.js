...
var CheckboxImplementationExamples = /** @class */ (function (_super) {
    ...
    CheckboxImplementationExamples.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Checkbox_1.Checkbox, { label: "Checkbox rendered with boxSide \"end\"", boxSide: "end", styles: checkboxStyles }),
            React.createElement(Checkbox_1.Checkbox, { label: "Persona Checkbox", styles: checkboxStyles, onRenderLabel: this._renderPersonaLabel })));
    };
    ...
    CheckboxImplementationExamples.prototype._renderPersonaLabel = function (props) {
        ...
        return React.createElement(Persona_1.Persona, { text: props.label, imageUrl: DEFAULT_IMAGE_URL, size: Persona_1.PersonaSize.size32 });
    };
