define(["require", "exports", "./extractStyleParts", "./concatStyleSets", "./styleToClassName"], function (require, exports, extractStyleParts_1, concatStyleSets_1, styleToClassName_1) {
    ...
    function mergeStyleSets() {
        ...
        if (styleSets.length > 1) {
            concatenatedStyleSet = concatStyleSets_1.concatStyleSets.apply(void 0, styleSets);
        }
        var registrations = [];
        for (var styleSetArea in concatenatedStyleSet) {
            if (concatenatedStyleSet.hasOwnProperty(styleSetArea)) {
                ...
                var registration = styleToClassName_1.styleToRegistration({ displayName: styleSetArea }, objects);
