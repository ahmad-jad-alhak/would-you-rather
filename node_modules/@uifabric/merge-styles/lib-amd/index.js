define(["require", "exports", "./mergeStyles", "./mergeStyleSets", "./concatStyleSets", "./fontFace", "./keyframes", "./Stylesheet", "./transforms/rtlifyRules"], function (require, exports, mergeStyles_1, mergeStyleSets_1, concatStyleSets_1, fontFace_1, keyframes_1, Stylesheet_1, rtlifyRules_1) {
    "use strict";
    ...
    exports.setRTL = rtlifyRules_1.setRTL;
});
