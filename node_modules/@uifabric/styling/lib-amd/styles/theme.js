define(["require", "exports", "tslib", "@uifabric/utilities", "./DefaultFontStyles", "./DefaultPalette", "./DefaultTypography", "@microsoft/load-themed-styles"], function (require, exports, tslib_1, utilities_1, DefaultFontStyles_1, DefaultPalette_1, DefaultTypography_1, load_themed_styles_1) {
    "use strict";
    ...
    var _theme = createTheme({
        ...
        isInverted: false,
        typography: DefaultTypography_1.DefaultTypography,
    ...
    function createTheme(theme, depComments) {
        ...
        var typography = utilities_1.merge({}, DefaultTypography_1.DefaultTypography, theme.typography);
        var variants = typography.variants;
        for (var variantName in variants) {
            if (variants.hasOwnProperty(variantName)) {
                var variant = tslib_1.__assign({}, variants.default, variants[variantName]);
