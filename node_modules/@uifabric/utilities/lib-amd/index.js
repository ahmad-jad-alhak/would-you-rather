define(["require", "exports", "tslib", "./Async", "./AutoScroll", "./BaseComponent", "./Context", "./Customizations", "./Customizer", "./DelayedRender", "./EventGroup", "./FabricPerformance", "./GlobalSettings", "./KeyCodes", "./Rectangle", "./aria", "./array", "./assertNever", "./autobind", "./classNamesFunction", "./createRef", "./css", "./customizable", "./dom", "./focus", "./hoist", "./hoistStatics", "./initializeFocusRects", "./initials", "./keyboard", "./language", "./math", "./memoize", "./merge", "./object", "./overflow", "./properties", "./resources", "./rtl", "./scroll", "./string", "./styled", "./warn"], function (require, exports, tslib_1, Async_1, AutoScroll_1, BaseComponent_1, Context_1, Customizations_1, Customizer_1, DelayedRender_1, EventGroup_1, FabricPerformance_1, GlobalSettings_1, KeyCodes_1, Rectangle_1, aria_1, array_1, assertNever_1, autobind_1, classNamesFunction_1, createRef_1, css_1, customizable_1, dom_1, focus_1, hoist_1, hoistStatics_1, initializeFocusRects_1, initials_1, keyboard_1, language_1, math_1, memoize_1, merge_1, object_1, overflow_1, properties_1, resources_1, rtl_1, scroll_1, string_1, styled_1, warn_1) {
    "use strict";
